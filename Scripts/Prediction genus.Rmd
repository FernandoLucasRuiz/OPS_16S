...
tse_prevalente <- agglomerateByRank(tse_lp, "Genus")
...
saveRDS(model.glm, "../../RDSs/paper/modelos_predictivos/model_AR_glm_10cv10rep.RDS")
```


```{r}
model.glm <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_glm_10cv10rep.RDS")
...
saveRDS(model.nb, "../../RDSs/paper/modelos_predictivos/model_AR_nb_10cv10rep.RDS")
```

```{r}
model.nb <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_nb_10cv10rep.RDS")
...
saveRDS(model.kknn, "../../RDSs/paper/modelos_predictivos/model_AR_kknn_10cv10rep.RDS")
```

```{r}
model.kknn <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_kknn_10cv10rep.RDS")
...
saveRDS(modelos_rf, "../../RDSs/paper/modelos_predictivos/model_AR_rf_10cv10rep.RDS")
```

```{r, fig.width=8, fig.height= 5}
modelos_rf <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_rf_10cv10rep.RDS")
...
saveRDS(model.xgb, "../../RDSs/paper/modelos_predictivos/model_AR_xgb_10cv10rep.RDS")
```

```{r}
model.xgb <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_xgb_10cv10rep.RDS")
...
saveRDS(model.svmlinear, "../../RDSs/paper/modelos_predictivos/model_AR_svml_10cv10rep.RDS")
```

```{r}
model.svmlinear <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_svml_10cv10rep.RDS")
...
saveRDS(model.svmradial, "../../RDSs/paper/modelos_predictivos/model_AR_svmr_10cv10rep.RDS")
```

```{r}
model.svmradial <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_svmr_10cv10rep.RDS")
...
saveRDS(model.svmpoly, "../../RDSs/paper/modelos_predictivos/model_AR_svmp_10cv10rep.RDS")
```

```{r}
model.svmpoly <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_svmp_10cv10rep.RDS")
...
saveRDS(model.mlp, "../../RDSs/paper/modelos_predictivos/model_AR_mlp_10cv10rep.RDS")
```

```{r}
model.mlp <- readRDS("../../RDSs/paper/modelos_predictivos/model_AR_mlp_10cv10rep.RDS")
...
saveRDS(model.glm, "../../RDSs/paper/modelos_predictivos/model_Survival_glm_10cv10rep.RDS")
```

```{r}
model.glm <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_glm_10cv10rep.RDS")
...
saveRDS(model.nb, "../../RDSs/paper/modelos_predictivos/model_Survival_nb_10cv10rep.RDS")
```

```{r}
model.nb <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_nb_10cv10rep.RDS")
...
saveRDS(model.kknn, "../../RDSs/paper/modelos_predictivos/model_Survival_kknn_10cv10rep.RDS")
```

```{r}
model.kknn <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_kknn_10cv10rep.RDS")
...
saveRDS(modelos_rf, "../../RDSs/paper/modelos_predictivos/model_Survival_rf_10cv10rep.RDS")
```

```{r, fig.width=8, fig.height= 5}
modelos_rf <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_rf_10cv10rep.RDS")
datos_combinados <- data.frame()
for (i in names(modelos_rf)){
...
saveRDS(model.xgb, "../../RDSs/paper/modelos_predictivos/model_Survival_xgb_10cv10rep.RDS")
```

```{r}
model.xgb <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_xgb_10cv10rep.RDS")
...
saveRDS(model.svmlinear, "../../RDSs/paper/modelos_predictivos/model_Survival_svml_10cv10rep.RDS")
```

```{r}
model.svmlinear <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_svml_10cv10rep.RDS")
...
saveRDS(model.svmradial, "../../RDSs/paper/modelos_predictivos/model_Survival_svmr_10cv10rep.RDS")
```

```{r}
model.svmradial <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_svmr_10cv10rep.RDS")
...
saveRDS(model.svmpoly, "../../RDSs/paper/modelos_predictivos/model_Survival_svmp_10cv10rep.RDS")
```

```{r}
model.svmpoly <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_svmp_10cv10rep.RDS")
...
saveRDS(model.mlp, "../../RDSs/paper/modelos_predictivos/model_Survival_mlp_10cv10rep.RDS")
```

```{r}
model.mlp <- readRDS("../../RDSs/paper/modelos_predictivos/model_Survival_mlp_10cv10rep.RDS")
...
colores <- c("grey80", "#C71000FF",  "#008EA0FF", "#FF6348F0",  "#5A9599FF", 
...
saveRDS(model.glm, "../../RDSs/paper/modelos_predictivos/model_AHT_glm_10cv10rep.RDS")
```

```{r}
model.glm <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_glm_10cv10rep.RDS")
...
saveRDS(model.nb, "../../RDSs/paper/modelos_predictivos/model_AHT_nb_10cv10rep.RDS")
```

```{r}
model.nb <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_nb_10cv10rep.RDS")
...
saveRDS(model.kknn, "../../RDSs/paper/modelos_predictivos/model_AHT_kknn_10cv10rep.RDS")
```

```{r}
model.kknn <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_kknn_10cv10rep.RDS")
...
saveRDS(modelos_rf, "../../RDSs/paper/modelos_predictivos/model_AHT_rf_10cv10rep.RDS")
```

```{r, fig.width=8, fig.height= 5}
modelos_rf <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_rf_10cv10rep.RDS")
...
saveRDS(model.xgb, "../../RDSs/paper/modelos_predictivos/model_AHT_xgb_10cv10rep.RDS")
```

```{r}
model.xgb <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_xgb_10cv10rep.RDS")
resample <- model.xgb$resample
resample$algoritmo <- "xgb"
...
saveRDS(model.svmlinear, "../../RDSs/paper/modelos_predictivos/model_AHT_svml_10cv10rep.RDS")
```

```{r}
model.svmlinear <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_svml_10cv10rep.RDS")
...
saveRDS(model.svmradial, "../../RDSs/paper/modelos_predictivos/model_AHT_svmr_10cv10rep.RDS")
```

```{r}
model.svmradial <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_svmr_10cv10rep.RDS")
...
saveRDS(model.svmpoly, "../../RDSs/paper/modelos_predictivos/model_AHT_svmp_10cv10rep.RDS")
```

```{r}
model.svmpoly <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_svmp_10cv10rep.RDS")
...
saveRDS(model.mlp, "../../RDSs/paper/modelos_predictivos/model_AHT_mlp_10cv10rep.RDS")
```

```{r}
model.mlp <- readRDS("../../RDSs/paper/modelos_predictivos/model_AHT_mlp_10cv10rep.RDS")
...
saveRDS(model.glm, "../../RDSs/paper/modelos_predictivos/model_Biliary_complications_glm_10cv10rep.RDS")
```

```{r}
model.glm <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_glm_10cv10rep.RDS")
...
saveRDS(model.nb, "../../RDSs/paper/modelos_predictivos/model_Biliary_complications_nb_10cv10rep.RDS")
```

```{r}
model.nb <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_nb_10cv10rep.RDS")
...
saveRDS(model.kknn, "../../RDSs/paper/modelos_predictivos/model_Biliary_complications_kknn_10cv10rep.RDS")
```

```{r}
model.kknn <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_kknn_10cv10rep.RDS")
...
saveRDS(modelos_rf, "../../RDSs/paper/modelos_predictivos/model_BC_rf_10cv10rep.RDS")
```

```{r, fig.width=8, fig.height= 5}
modelos_rf <- readRDS("../../RDSs/paper/modelos_predictivos/model_BC_rf_10cv10rep.RDS")
datos_combinados <- data.frame()
for (i in names(modelos_rf)){
...
saveRDS(model.xgb, "../../RDSs/paper/modelos_predictivos/model_BC_xgb_10cv10rep.RDS")
```

```{r}
model.xgb <- readRDS("../../RDSs/paper/modelos_predictivos/model_BC_xgb_10cv10rep.RDS")
resample <- model.xgb$resample
resample$algoritmo <- "xgb"
...
saveRDS(model.svmlinear, "../../RDSs/paper/modelos_predictivos/model_Biliary_complications_svml_10cv10rep.RDS")
```

```{r}
model.svmlinear <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_svml_10cv10rep.RDS")
...
saveRDS(model.svmradial, "../../RDSs/paper/modelos_predictivos/model_BC_svmr_10cv10rep.RDS")
```

```{r}
model.svmradial <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_svmr_10cv10rep.RDS")
...
saveRDS(model.svmpoly, "../../RDSs/paper/modelos_predictivos/model_Biliary_complications_svmp_10cv10rep.RDS")
```

```{r}
model.svmpoly <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_svmp_10cv10rep.RDS")
...
saveRDS(model.mlp, "../../RDSs/paper/modelos_predictivos/model_BC_mlp_10cv10rep.RDS")
```

```{r}
model.mlp <- readRDS("../../RDSs/paper/modelos_predictivos/model_Biliary_complications_mlp_10cv10rep.RDS")
...
probs_rf<- predict(modelos_rf$`2000`, testSet, type = "prob")[, 2]
...
#save.image("../../Rdatas/predicciones_genus_10cv10rep.RData")
```

```{r}
#load("../../Rdatas/predicciones_genus.RData") # Esto es la imagen de 3 rep 10cv
#load("../../Rdatas/predicciones_genus_10cv10rep.RData") # Esto es la imagen de 20 rep 5cv
```
